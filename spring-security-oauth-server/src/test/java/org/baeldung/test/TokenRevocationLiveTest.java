...
public class TokenRevocationLiveTest {
	...
	public void whenObtainingAccessToken_thenCorrect() {
		...
		final String accessToken = authServerResponse.jsonPath().getString(
				"access_token");
		assertNotNull(accessToken);

		final Response resourceServerResponse = RestAssured
				.given()
	...
	public void refreshAccessToken() {
		final String oldAccessToken = obtainAccessOldToken(
				"fooClientIdPassword", "user1", "pass");
		final String newAccessToken = obtainNewAccessToken(
				"fooClientIdPassword", "user1", "pass");
		assertNotSame(newAccessToken, oldAccessToken);
	}

	private String obtainAccessOldToken(String clientId, String username,
			String password) {
		Response response = obtainAccessTokenResponse(clientId, username,
				password);
		return response.jsonPath().getString("access_token");
	}

	private String obtainNewAccessToken(String clientId, String username,
			String password) {
		Response response = obtainAccessTokenResponse(clientId, username,
				password);
	...
	private Response obtainRefreshTokenResponse(String clientId,
			String refreshToken) {
	...
	private Response obtainAccessTokenResponse(String clientId,
	...
	private Response obtainAccessToken(String clientId, String username,
			String password) {
		final Map<String, String> params = new HashMap<String, String>();
		params.put("grant_type", "password");
		params.put("client_id", clientId);
	...
	// final String accessToken1 = obtainAccessToken("fooClientIdPassword",
	// "john", "123");
	// final String accessToken2 = obtainAccessToken("fooClientIdPassword",
	// "tom", "111");
	...
	// @Test
	// public void
	// givenUser_whenRevokeRefreshToken_thenRefreshTokenInvalidError() {
	// final String accessToken1 = obtainAccessToken("fooClientIdPassword",
	// "john", "123");
	// final String accessToken2 = obtainAccessToken("fooClientIdPassword",
	// "tom", "111");
